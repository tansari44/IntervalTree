...
public class IntervalTree {
	...
	public void mapIntervalsToTree(ArrayList<Interval> leftSortedIntervals, ArrayList<Interval> rightSortedIntervals) {
		...
		for(int i = 0; i < leftSortedIntervals.size(); i++){
		    ...
		    Stack<IntervalTreeNode> stack = new Stack<IntervalTreeNode>( );
		    stack.push(curr);
		 
		    while(!stack.isEmpty()) {
		        IntervalTreeNode current = stack.pop();
		        ...
		        if(curr.splitValue >= leftSortedIntervals.get(i).leftEndPoint){
					curr.leftIntervals.add(leftSortedIntervals.get(i));
				}
